...
public class AuthServiceImpl implements IAuthService {
    ...
    public LoginResponse login(LoginRequest loginRequest) {
        ...
        return buildLoginResponse(userDetails, accessToken);
    }

    private LoginResponse buildLoginResponse(UserDetailsImpl userDetails, String accessToken) {
    ...
    public LoginResponse refreshAccessToken(String refreshToken) {
        return Optional.ofNullable(refreshToken)
                ...
                .map(user -> buildLoginResponse(user, jwtUtils.generateAccessToken(user)))
